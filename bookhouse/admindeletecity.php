...
<body>
<br><br><br><br>
<form action="admindeletecitysubmit.php" method="post">
...
<center>Citystateno:- <input type="text" name="citystateno" size=20 maxlength=20></center>
<br><br>
<center><br><input type="submit" name="Delete City/state" value="delete city/state" >
</body>
</html>