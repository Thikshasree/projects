...
<body>
<br><br><br><br>
<form action="admindeletebookssubmit.php" method="post">
...
<center>Book No:- <input type="text" name="bookno" size=20 maxlength=20></center>
<br><br>
<center><br><input type="submit" name="Delete Book" value="delete Book" >
</body>
</html>