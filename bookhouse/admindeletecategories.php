...
<body>
<br><br><br><br>
<form action="admindeletecategoriessubmit.php" method="post">
...
<center>Category No:- <input type="text" name="categoryno" size=20 maxlength=20></center>
<br><br>
<center><br><input type="submit" name="Delete Category" value="delete Category" >
</body>
</html>