...
<body>
<br><br><br><br>
<form action="admindeletecustomerssubmit.php" method="post">
...
<center>Customer No:- <input type="text" name="customerno" size=20 maxlength=20></center>
<br><br>
<center><br><input type="submit" name="Delete Customer" value="delete Customer" >
</body>
</html>