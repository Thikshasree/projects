...
<body>
<br><br><br><br>
<form action="adminupdatecountrysubmit.php" method="post">
...
<center>Country Number:- <input type="text" name="countryno" size=20 maxlength=20></center>
<br><br>
<center>Country Name:- <input type="text" name="country" size=20 maxlength=20></center>
<br><br>

<center><br><input type="submit" name="addcountry" value="addcountry" >
</body>
</html>